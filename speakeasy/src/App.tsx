...
function App() {
  ...
  // One boundary around every step (onboarding included, not just the Hub) —
  // a crash anywhere in the app shows the reload screen instead of unmounting
  // to blank. The Toaster stays outside it since it's rendered via its own
  // portal and shouldn't disappear if the boundary trips.
  return (
    <>
      {toaster}
