...
pub fn run(cli_args: CliArgs) {
    ...
    let specta_builder = Builder::<tauri::Wry>::new()
        .commands(collect_commands![
            ...
            shortcut::change_polish_level_setting,
            shortcut::change_polish_ollama_model_setting,
            shortcut::change_polish_llm_timeout_setting,
            shortcut::change_spacebar_ptt_setting,
            shortcut::change_spacebar_hold_threshold_setting,
            shortcut::change_show_idle_pill_setting,
    ...
    builder
        ...
        // LocalFlow: the Tauri updater plugin and its phone-home update check are
        // removed — no version-check network traffic, and no updater artifacts to
        // sign at build time.
        ...
        .setup(move |app| {
            ...
            // Show the persistent idle pill (Wispr-style dot) if enabled. The
            // window then stays mapped at idle; active states swap visuals in
            // place and hide_recording_overlay returns here rather than hiding.
